<template>
  <div>
    ...
    <div class="rightSide">
     ...
     <VillageengineeringDetail v-if="crowdPop==1" @close="crowdPop=null"/>
  </div>
</template>

<script>
import { bar_chart3, pie_chart2 } from '@/assets/js/m_chart.js'
import VillageengineeringDetail from '@/components/pop/village_engineering_detail.vue'
export default {
  components: {
